...
var mysql = function(config){
  ...
  */
  ...
  conn.realConnectSync(config.host, config.user, config.pass, config.db, config.port);  conn.realConnectSync(config.host, config.user, config.pass, config.db, config.port);
